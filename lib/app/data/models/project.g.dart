...
void _projectSerialize(
  ...
  writer.writeLong(offsets[0], object.data);
...
Project _projectDeserialize(
  ...
  object.data = reader.readLongOrNull(offsets[0]);
  object.id = id;
  object.title = reader.readStringOrNull(offsets[1]);
  object.type = _ProjecttypeValueEnumMap[reader.readByteOrNull(offsets[2])] ??
      ProjectType.image;
  return object;
}
...
P _projectDeserializeProp<P>(
  ...
  switch (propertyId) {
    ...
    case 2:
      return (_ProjecttypeValueEnumMap[reader.readByteOrNull(offset)] ??
          ProjectType.image) as P;
    default:
...
extension ProjectQueryFilter
  ...
  QueryBuilder<Project, Project, QAfterFilterCondition> dataIsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Project, Project, QAfterFilterCondition> dataIsNotNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Project, Project, QAfterFilterCondition> dataEqualTo(
      int? value) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Project, Project, QAfterFilterCondition> dataGreaterThan(
    int? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Project, Project, QAfterFilterCondition> dataLessThan(
    int? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Project, Project, QAfterFilterCondition> dataBetween(
    int? lower,
    int? upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension ProjectQuerySortBy on QueryBuilder<Project, Project, QSortBy> {
  QueryBuilder<Project, Project, QAfterSortBy> sortByData() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'data', Sort.asc);
    });
  }

  QueryBuilder<Project, Project, QAfterSortBy> sortByDataDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension ProjectQuerySortThenBy
  ...
  QueryBuilder<Project, Project, QAfterSortBy> thenByData() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'data', Sort.asc);
    });
  }

  QueryBuilder<Project, Project, QAfterSortBy> thenByDataDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'data', Sort.desc);
    });
  }
...
extension ProjectQueryWhereDistinct
  ...
  QueryBuilder<Project, Project, QDistinct> distinctByData() {
    return QueryBuilder.apply(this, (query) {
...
extension ProjectQueryProperty
  ...
  QueryBuilder<Project, int?, QQueryOperations> dataProperty() {
    return QueryBuilder.apply(this, (query) {
